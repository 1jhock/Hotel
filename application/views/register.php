...
<div class="heading">
	<div class="row">
		...
		<div class="col-lg-4"><h1 class="text-center">Register</h1></div>
		<div class="col-lg-4">
		...
		<div class="row">
			<div class="col-lg-8">
				<div class="form-group">
					...
					<input type="text" class="form-control" name="name" id="name" placeholder="Surname | Given Name | M.I.">
				</div>
			...
			<div class="col-lg-4 input-container">
				<div class="form-group">
					...
					<input type="number" class="form-control" name="num_person" id="num_person">
				</div>

				<div class="form-group">
					<label for="arrival">Arrival</label>
					<input type="date" class="form-control" name="date_arrival" id="arrival">
				</div>

				<div class="form-group">
					<label for="depart">Departure</label>
					<input type="date" class="form-control" name="date_depart" id="depart">
				</div>
				<hr>
				<div class="form-group">
		...
		<div class="row">
			<div class="col-lg-4">
				<div class="register-container">
					...
					<input checked="check" type="radio" name="payment" value="Cash" id="cash">
			...
			<div class="col-lg-4">
				<div class="register-container">
					...
					<input type="text" class="form-control" name="charge_to" id="charge_to">
				</div>

				<div class="form-group">
					<label for="registrar">Registrar's Initial/Practicum</label>
					<input type="text" class="form-control" name="registrar" id="registrar">
				</div>
				</div>
			</div>
		</div>
		<hr>
		<button class="btn btn-info center-block" type="submit">Register</button>
		</form>
		<br>
		<br>
		<br>
